...
class DecoderTransformerStackICL(nn.Module):
    ...
    def __noncausal_forward(
        ...
        for t in forward_idxs:
            ...
            if y is not None and self.loss_fn is not None:
                ...
                loss_sum += loss if fast_backward else loss.detach()
                if backward and not fast_backward:
    ...
    def forward(
        ...
        if self.is_causal:
            ...
            return self.__noncausal_forward(x, y, backward, forward_idxs, fast_backward)
